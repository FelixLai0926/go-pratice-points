...
func newTransactionEvent(db *gorm.DB, opts ...gen.DOOption) transactionEvent {
	...
	_transactionEvent.transactionEventDo.UseModel(&model.TransactionEvent{})
...
type ITransactionEventDo interface {
	...
	Create(values ...*model.TransactionEvent) error
	CreateInBatches(values []*model.TransactionEvent, batchSize int) error
	Save(values ...*model.TransactionEvent) error
	First() (*model.TransactionEvent, error)
	Take() (*model.TransactionEvent, error)
	Last() (*model.TransactionEvent, error)
	Find() ([]*model.TransactionEvent, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.TransactionEvent, err error)
	FindInBatches(result *[]*model.TransactionEvent, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.TransactionEvent) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model.TransactionEvent, error)
	FirstOrCreate() (*model.TransactionEvent, error)
	FindByPage(offset int, limit int) (result []*model.TransactionEvent, count int64, err error)
...
func (t transactionEventDo) Create(values ...*model.TransactionEvent) error {
	if len(values) == 0 {
		return nil
	}
...
func (t transactionEventDo) CreateInBatches(values []*model.TransactionEvent, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t transactionEventDo) Save(values ...*model.TransactionEvent) error {
	if len(values) == 0 {
		return nil
	}
...
func (t transactionEventDo) First() (*model.TransactionEvent, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model.TransactionEvent), nil
	}
}

func (t transactionEventDo) Take() (*model.TransactionEvent, error) {
...
func (t transactionEventDo) Last() (*model.TransactionEvent, error) {
...
func (t transactionEventDo) Find() ([]*model.TransactionEvent, error) {
	result, err := t.DO.Find()
	return result.([]*model.TransactionEvent), err
}

func (t transactionEventDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.TransactionEvent, err error) {
	buf := make([]*model.TransactionEvent, 0, batchSize)
...
func (t transactionEventDo) FindInBatches(result *[]*model.TransactionEvent, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t transactionEventDo) FirstOrInit() (*model.TransactionEvent, error) {
...
func (t transactionEventDo) FirstOrCreate() (*model.TransactionEvent, error) {
...
func (t transactionEventDo) FindByPage(offset int, limit int) (result []*model.TransactionEvent, count int64, err error) {
...
func (t transactionEventDo) Delete(models ...*model.TransactionEvent) (result gen.ResultInfo, err error) {
