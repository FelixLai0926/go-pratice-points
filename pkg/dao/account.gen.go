...
func newAccount(db *gorm.DB, opts ...gen.DOOption) account {
	...
	_account.accountDo.UseModel(&orm.Account{})
...
func (a *account) fillFieldMap() {
	...
	a.fieldMap["available_balance"] = a.AvailableBalance
	a.fieldMap["reserved_balance"] = a.ReservedBalance
...
type IAccountDo interface {
	...
	Unscoped() IAccountDo
	Create(values ...*orm.Account) error
	CreateInBatches(values []*orm.Account, batchSize int) error
	Save(values ...*orm.Account) error
	First() (*orm.Account, error)
	Take() (*orm.Account, error)
	Last() (*orm.Account, error)
	Find() ([]*orm.Account, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*orm.Account, err error)
	FindInBatches(result *[]*orm.Account, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*orm.Account) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*orm.Account, error)
	FirstOrCreate() (*orm.Account, error)
	FindByPage(offset int, limit int) (result []*orm.Account, count int64, err error)
...
func (a accountDo) Create(values ...*orm.Account) error {
	if len(values) == 0 {
		return nil
	}
...
func (a accountDo) CreateInBatches(values []*orm.Account, batchSize int) error {
	return a.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (a accountDo) Save(values ...*orm.Account) error {
	if len(values) == 0 {
		return nil
	}
...
func (a accountDo) First() (*orm.Account, error) {
	if result, err := a.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*orm.Account), nil
	}
}

func (a accountDo) Take() (*orm.Account, error) {
...
func (a accountDo) Last() (*orm.Account, error) {
...
func (a accountDo) Find() ([]*orm.Account, error) {
	result, err := a.DO.Find()
	return result.([]*orm.Account), err
}

func (a accountDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*orm.Account, err error) {
	buf := make([]*orm.Account, 0, batchSize)
...
func (a accountDo) FindInBatches(result *[]*orm.Account, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (a accountDo) FirstOrInit() (*orm.Account, error) {
...
func (a accountDo) FirstOrCreate() (*orm.Account, error) {
...
func (a accountDo) FindByPage(offset int, limit int) (result []*orm.Account, count int64, err error) {
...
func (a accountDo) Delete(models ...*orm.Account) (result gen.ResultInfo, err error) {
